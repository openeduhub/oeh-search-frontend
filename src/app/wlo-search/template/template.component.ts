...
export class TemplateComponent implements OnInit {
    ...
    jobsContentConfig = computed(() =>
        JSON.stringify({
            ...
            description:
                'Hier findest du eine Sammlung verschiedener spannender Berufe im Zusammenhang mit ' +
                this.topic(),
    ...
    ngOnInit(): void {
        ...
        this.topic = signal(this.initialTopic);
